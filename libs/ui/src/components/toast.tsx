...
function ToastClose({
  className,
  children,
  // The app owns its words; this default only covers a caller that says
  // nothing, and an unnamed close button is worse than an English one.
  "aria-label": label = "Close toast",
