...
import type { AdherenceFinding } from "@velachess/repertoire";
...
/**
 * Where a finding belongs on the screen — taxonomy only, ranking never looks at it.
 * `critical` is never emitted by a source: it's the top of the global ranking, derived at presentation, not a self-declared exemption from comparison.
 */
